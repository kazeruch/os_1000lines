...
$CC $CFLAGS -Wl,-Tuser.ld -Wl,-Map=pong.map -o pong.elf pong.c user.c common.c
$OBJCOPY --set-section-flags .bss=alloc,contents -O binary pong.elf pong.bin
$OBJCOPY -Ibinary -Oelf32-littleriscv pong.bin pong.bin.o

# カーネルをビルド
$CC $CFLAGS -Wl,-Tkernel.ld -Wl,-Map=kernel.map -o kernel.elf \
    kernel.c common.c pong.bin.o
