...
paddr_t alloc_pages(uint32_t n) {
    static paddr_t next_paddr = (paddr_t) __free_ram; // 値を保持するための static
...
// プロセスの初期化処理。実行開始アドレス(pc)を受け取り、プロセス管理構造体を初期化して返す。
